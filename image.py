...
def showImage(path):
    lb_image.hide()
    pixmapimage: QPixmap | QPixmap = QPixmap(path)
...
btn_left.clicked.connect(workimage.leftImage)
btn_right.clicked.connect(workimage.rightImage)
btn_flip.clicked.connect(workimage.flipImage)
btn_sharp.clicked.connect(workimage.sharpImage)
